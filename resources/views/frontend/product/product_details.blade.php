        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 order-lg-2 order-1">
                    ...
                    <div class="image_selected"><img src="{{ asset('public/files/product/' . $product->thumbnail) }}"
                            alt=""></div>
                </div>
                                    ...
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            ...
                                            <a href="{{ route('add.wishlist', $product->id) }}"
                                                class="btn btn-outline-primary" type="button">Add to
                                                wishlist</a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-3 order-3" style="border-left: 1px solid grey; padding-left: 10px;">
                    ...
                    @isset($product->video)
                        ...
                        <iframe width="340" height="205" src="https://www.youtube.com/embed/{{ $product->video }}"
                                    ...
                                    <div
                                        ...
                                        <div class="viewed_content text-center">
                                            @if ($row->discount_price == null)
                                                <div class="viewed_price"> {{ $setting->currency }}
                                            ...
                                            <div class="viewed_name"><a
                                                    href="{{ route('product.details', $row->slug) }}">{{ substr($row->name, 0, 50) }}</a>
                                            </div>
                                        </div>
                                        <ul class="item_marks">
