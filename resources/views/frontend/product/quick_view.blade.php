...
<div class="modal-body product_view d-none">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-4">
                <div class="">
                    <img src="{{ asset('public/files/product/' . $product->thumbnail) }}" height="50%" width="80%">
                </div>
            </div>
            <div class="col-lg-8 ">
                <h3>{{ $product->name }}</h3>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-lg-1" style="margin-left: -5px;">
                                    ...
                                    <input type="number" min="1" max="100" name="qty" class="form-control-sm" value="1" style="margin-left: 25px;">
                                </div>
                            </div>
