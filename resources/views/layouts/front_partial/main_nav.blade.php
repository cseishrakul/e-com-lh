                    ...
                    <div class="cat_menu_container">
                        ...
                        <ul class="cat_menu">
                            @foreach ($category as $row)
                                ...
                                @endphp
                                <li class="hassubs">
                                    <a href="{{ route('categorywise.product', $row->id) }}"> <img
                                            src="{{ asset($row->icon) }}" width="16" height="16" alt="">
                                    ...
                                    <ul>
                                        @foreach ($subcategory as $row)
                                            ...
                                            @endphp
                                            <li class="hassubs">
                                                <a href="{{ route('subcategorywise.product', $row->id) }}">
                                                    {{ $row->subcategory_name }} <i
                                                        class="fas fa-chevron-right"></i></a>
                                                <ul>
                                                    @foreach ($childcategory as $row)
                                                        <li><a href="{{ route('childcategorywise.product', $row->id) }}">
                                                                {{ $row->childcategory_name }} <i
