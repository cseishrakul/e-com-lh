                ...
                <div class="main_nav_content d-flex flex-row">
                    ...
                    <div class="cat_menu_container">
                        ...
                        <ul class="cat_menu">
                            ...
                            @endphp
                            <li class="hassubs">
                                <a href="{{route('categorywise.product',$row->id)}}"> <img src="{{asset($row->icon)}}" width="16" height="16" alt=""> {{$row->category_name}} <i class="fas fa-chevron-right"></i></a>
                                <ul>
                    ...
                    <div class="main_nav_menu ml-auto">
                        <ul class="standard_dropdown main_nav_dropdown">
                            ...
                            <li>
                                <a href="index.html">Campaign<i class="fas fa-chevron-down"></i></a>
                            </li>
                            <li>
                                <a href="index.html">Helpline<i class="fas fa-chevron-down"></i></a>
                            </li>
                            <li>
                                <a href="blog.html">Blog<i class="fas fa-chevron-down"></i></a>
                            </li>
                            <li>
                                <a href="contact.html">Contact<i class="fas fa-chevron-down"></i></a>
                            </li>
                        </ul>
                    </div>
