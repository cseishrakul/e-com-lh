                                                ...
                                                @foreach ($category as $row)
                                                    @php
                                                        $subcategory = DB::table('subcategories')
                                                            ...
                                                            ->get();
                                                    @endphp
                                                    <option style="color: rgb(33, 103, 168)" disabled>
                                                        {{ $row->category_name }}</option>
                                                    @foreach ($subcategory as $row)
                                                        <option value="{{ $row->id }}"  @if($row->id == $product->subcategory_id) selected  @endif>-- {{ $row->subcategory_name }}
                                                        </option>
                                                    @endforeach
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <select class="form-control" name="pickup_point_id">
                                                @foreach ($pickup_point as $row)
                                                    <option value="{{ $row->id }}" @if($row->id == $product->pickup_point_id) selected  @endif>
                                                        {{ $row->pickup_point_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <input type="text" name="tags" class="form-control"
                                                value="{{$product->tags}}" name="tags" data-role="tagsinput">
                                        </div>
                                    </div>
                                    <div class="row">
                            ...
                            <div class="card card-primary">
                                <div class="card-body">
                                    <div class="form-group">
                                        <img src="{{asset('public/files/product/'.$product->thumbnail)}}" style="width:50px; height:50px;" alt="">
                                    ...
                                    <div class="card p-4">
                                        ...
                                        <input type="checkbox" @if ($product->featured==1)checked @endif data-toggle="toggle" data-onstyle="success"
                                            data-offstyle="danger" data-size="sm" value="1" name="featured">
                                    </div>

                                    <div class="card p-4">
                                        <h6>Today Deal</h6>
                                        <input type="checkbox"  @if ($product->today_deal==1)checked @endif data-toggle="toggle" data-onstyle="success"
                                            data-offstyle="danger" data-size="sm" value="1" name="today_deal">
                                    </div>

                                    <div class="card p-4">
                                        <h6>Slider Product</h6>
                                        <input type="checkbox" @if ($product->product_slider==1)checked @endif data-toggle="toggle" data-onstyle="success"
                                            data-offstyle="danger" data-size="sm" value="1" name="product_slider">
                                    </div>

                                    <div class="card p-4">
                                        <h6>Trendy Product</h6>
                                        <input type="checkbox"  @if ($product->trendy==1)checked @endif data-toggle="toggle" data-onstyle="success"
                                            data-offstyle="danger" data-size="sm" value="1" name="trendy">

                                    </div>

                                    <div class="card p-4">
                                        <h6>Status</h6>
                                        <input type="checkbox"  @if ($product->status==1)checked @endif data-toggle="toggle" data-onstyle="success"
                                            data-offstyle="danger" data-size="sm" value="1" name="status">
                                    </div>
