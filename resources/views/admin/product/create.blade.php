                            ...
                            <div class="card card-primary">
                                <div class="card-body">
                                    ...
                                    <div class="card p-4">
                                        ...
                                        <input type="checkbox" checked data-toggle="toggle" data-onstyle="success" data-offstyle="danger" data-size="sm"
                                    ...
                                    <div class="card p-4">
                                        <h6>Today Deal</h6>
                                        <input type="checkbox" checked data-toggle="toggle" data-onstyle="success" data-offstyle="danger" data-size="sm"
                                            value="1" name="today_deal">
                                    </div>

                                    <div class="card p-4">
                                        <h6>Slider Product</h6>
                                        <input type="checkbox" data-toggle="toggle" data-onstyle="success" data-offstyle="danger" data-size="sm"
                                            value="1" name="product_slider">
                                    </div>
