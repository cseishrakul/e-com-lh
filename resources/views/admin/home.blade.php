                                                ...
                                                <li>
                                                    @if ($row->avatar == null)
                                                        <img src="https://thumbs.dreamstime.com/b/businessman-icon-vector-male-avatar-profile-image-profile-businessman-icon-vector-male-avatar-profile-image-182095609.jpg"
                                                            alt="User Image" style="height:60px;">
                                                    @else
                                                    ...
                                                    <span class="users-list-date">
                                                        {{ date('d F Y'), strtotime($row->created_at) }} </span>
                                                </li>
                                            @endforeach
                                        </ul>
                                        <!-- /.users-list -->
                                    ...
                                    @foreach ($most_views as $row)
                                        <li class="item">
                                            <div class="product-img">
                                                <img src="{{asset('public/files/product/'.$row->thumbnail)}}" alt="Product Image"
                                                    class="img-size-50">
                                            </div>
                                            <div class="product-info">
                                                <a href="javascript:void(0)" class="product-title"> {{$row->product_views}} Times View
                                                    <span class="badge badge-danger float-right text-light">  {{$setting->currency}} {{$row->selling_price}} </span></a>
